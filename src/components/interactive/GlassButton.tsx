...
/**
 * Variantes de style du bouton Liquid Glass.
...
export interface GlassButtonProps
  ...
  borderRadius?: string;
  /** Active ou désactive le faisceau animé qui parcourt la bordure. Défaut : true pour primary/outline, false pour ghost */
...
/**
 * GlassButton — Composant bouton Liquid Glass unifié et polymorphique.
 *
 ...
 * 5. Respect strict de la palette Analyticatech (#F26D3D, Dark/Light bithème).
 */
const GlassButton = React.forwardRef<HTMLButtonElement, GlassButtonProps>(
  (
    ...
    // Animation de bordure activée par défaut pour primary / outline
    const shouldAnimateBorder =
      showBorderAnimation ?? (variant === "primary" || variant === "outline");

    const innerContent = (
      <>
        {/* Faisceau laser qui parcourt la bordure */}
        {shouldAnimateBorder && !disabled && (
