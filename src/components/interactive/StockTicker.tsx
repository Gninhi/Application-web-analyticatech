...
const DEFAULT_TECH_TICKERS_FR: TechTickerItem[] = [
  { code: "RAG-01", name: "Raisonnement & RAG", delta: "▲ 280ms", status: "LIVE" },
  { code: "AGNT-02", name: "Multi-Agents Swarms", delta: "▲ 38 ACTIFS", status: "LIVE" },
  { code: "AUTO-03", name: "Workflows n8n & Orchestration", delta: "▲ 48 FLUX", status: "PROD" },
  { code: "DATA-04", name: "Data Platform & dbt Core", delta: "▲ 42 KPI", status: "ONLINE" },
  { code: "LLM-05", name: "Inférence vLLM & Guardrails", delta: "▲ 94.2% ACC", status: "LIVE" },
  { code: "VCTR-06", name: "Vector Search Qdrant", delta: "▲ <15ms", status: "ACTIVE" },
  { code: "SOUV-07", name: "Souveraineté Cloud & RGPD", delta: "● 100% EU", status: "AUDITED" },
  { code: "PROD-08", name: "Déploiement CI/CD Cloud", delta: "▲ 99.9% UP", status: "STABLE" },
  { code: "TRFM-09", name: "Transformation Cognitive", delta: "▲ 35% GAIN", status: "LIVE" },
  { code: "GOV-10", name: "Gouvernance des Données", delta: "● PII MASK", status: "ACTIF" },
];

const DEFAULT_TECH_TICKERS_EN: TechTickerItem[] = [
  { code: "RAG-01", name: "Reasoning & RAG", delta: "▲ 280ms", status: "LIVE" },
  { code: "AGNT-02", name: "Multi-Agent Swarms", delta: "▲ 38 ACTIVE", status: "LIVE" },
  { code: "AUTO-03", name: "n8n Workflows & Orchestration", delta: "▲ 48 FLOWS", status: "PROD" },
  { code: "DATA-04", name: "Data Platform & dbt Core", delta: "▲ 42 KPI", status: "ONLINE" },
  { code: "LLM-05", name: "vLLM Inference & Guardrails", delta: "▲ 94.2% ACC", status: "LIVE" },
  { code: "VCTR-06", name: "Qdrant Vector Search", delta: "▲ <15ms", status: "ACTIVE" },
  { code: "SOUV-07", name: "Cloud Sovereignty & GDPR", delta: "● 100% EU", status: "AUDITED" },
  { code: "PROD-08", name: "Cloud CI/CD Deployment", delta: "▲ 99.9% UP", status: "STABLE" },
  { code: "TRFM-09", name: "Cognitive Transformation", delta: "▲ 35% GAIN", status: "LIVE" },
...
const TICKER_META_DICTIONARY: Record<string, { code: string; delta: string; status: string }> = {
  IA: { code: "AI-01", delta: "▲ 280ms", status: "LIVE" },
  AI: { code: "AI-01", delta: "▲ 280ms", status: "LIVE" },
  Agents: { code: "AGNT-02", delta: "▲ 38 actifs", status: "LIVE" },
  Automatisation: { code: "AUTO-03", delta: "▲ 48 flux", status: "PROD" },
  Automation: { code: "AUTO-03", delta: "▲ 48 flows", status: "PROD" },
  Transformation: { code: "TRFM-04", delta: "▲ 35% gain", status: "LIVE" },
  BI: { code: "BI-05", delta: "▲ 42 KPIs", status: "LIVE" },
  RAG: { code: "RAG-06", delta: "▲ 94.2%", status: "PROD" },
  LLM: { code: "LLM-07", delta: "▲ 99.9%", status: "LIVE" },
  Data: { code: "DATA-08", delta: "▲ 28 sources", status: "LIVE" },
