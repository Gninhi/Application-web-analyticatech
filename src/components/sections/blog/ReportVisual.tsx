 ...
 * Rendu SSR-stable pour garantir zéro erreur d'hydratation React.
 */
export function ReportVisual({ accent, className, children }: ReportVisualProps) {
  ...
  return (
    <div className={cn("relative z-20 overflow-hidden", className)} style={{ background: gradient }}>
      ...
      {/* Balayage lumineux — géré par Framer Motion et neutralisé en CSS sous prefers-reduced-motion */}
      <motion.div
        initial={{ x: "-140%" }}
        animate={{ x: "140%" }}
