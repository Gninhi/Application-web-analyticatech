          ...
          <div className="glass-card rounded-2xl border border-black/15 dark:border-white/15 shadow-2xl shadow-black/50 p-5 md:p-6">
            <div className="flex items-start gap-3 mb-3">
              ...
              <button
                ...
                className="shrink-0 text-slate-500 hover:text-slate-400 dark:hover:text-slate-400 dark:text-slate-300 transition-colors"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-[#F26D3D] px-4 py-2.5 font-mono text-xs font-semibold uppercase tracking-wider text-white transition hover:bg-[#ff7a4a] neon-glow"
              >
              ...
              <button
                onClick={() => saveChoice("refused")}
                className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg border border-black/15 dark:border-white/15 px-4 py-2.5 font-mono text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-300 transition hover:border-black/40 dark:hover:border-white/40 hover:text-slate-900 dark:hover:text-white"
              >
                <X className="h-4 w-4" aria-hidden />
                Tout refuser
              </button>
