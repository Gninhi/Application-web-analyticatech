...
export const FALLBACK_METRICS_FR: MetricDTO[] = [
  ...
  },
  {
    ...
    suffix: "%",
    trend: -35.0,
    sparkline: [60, 52, 45, 40, 38, 36, 35],
    source: "bento",
    order: 2,
  },
  {
    ...
    suffix: "%",
    trend: 99.9,
    sparkline: [99.8, 99.85, 99.9, 99.9, 99.95, 99.9, 99.9],
    source: "bento",
    order: 3,
  },
  {
    ...
    label: "Satisfaction C-Level",
    value: "4.9/5",
    numericValue: 4.9,
    suffix: "/5",
    trend: 4.9,
    sparkline: [4.6, 4.7, 4.8, 4.8, 4.9, 4.9, 4.9],
    source: "bento",
    order: 4,
  },
  {
...
export const FALLBACK_DELIVERY_STEPS_FR: DeliveryStepDTO[] = [
  ...
  },
  {
    ...
    description: "Supervision 24/7, détection de dérive des modèles et itérations mensuelles à forte valeur ajoutée.",
    order: 4,
  },
];
...
export const FALLBACK_DELIVERY_STEPS_EN: DeliveryStepDTO[] = [
  ...
  },
  {
    ...
    description: "24/7 observability, drift detection, and high-impact monthly iterations without technical debt.",
    order: 4,
  },
];
...
export const FALLBACK_CAPABILITIES_FR: CapabilityDTO[] = [
  ...
  },
  {
    ...
    features: ["Pipelines n8n & Temporal", "Connecteurs API standardisés", "Monitoring Prometheus 24/7"],
    order: 3,
  },
  {
    id: "cap-4",
...
export const FALLBACK_CAPABILITIES_EN: CapabilityDTO[] = [
  ...
  },
  {
    ...
    features: ["Temporal & n8n engines", "Standardized API connectors", "24/7 Prometheus telemetry"],
    order: 3,
  },
  {
    id: "cap-4",
...
export const FALLBACK_LEGAL_SECTIONS_FR: LegalSectionDTO[] = [
  {
    ...
    body: "Le site Analyticatech est édité par la société Analyticatech SAS, domiciliée au 60 rue François 1er, 75008 Paris, France. Directeur de la publication : Équipe de Direction Analyticatech. Contact : contact@analyticatech.fr.",
    order: 1,
  },
  {
    id: "leg-2",
    type: "legal",
    heading: "2. Hébergement & Sécurité",
    body: "Le site est hébergé sur une infrastructure cloud hautement sécurisée conforme aux standards européens de protection des données et certifiée ISO 27001.",
    order: 2,
  },
  {
    id: "leg-3",
...
export const FALLBACK_LEGAL_SECTIONS_EN: LegalSectionDTO[] = [
  {
    ...
    type: "legal",
    heading: "1. Publisher",
    body: "The Analyticatech website is published by Analyticatech SAS, located at 60 rue François 1er, 75008 Paris, France. Contact: contact@analyticatech.fr.",
    order: 1,
  },
  {
    id: "leg-2",
    type: "legal",
    heading: "2. Hosting & Security",
    body: "The website is hosted on high-security cloud infrastructure compliant with European data protection regulations and ISO 27001 standards.",
    order: 2,
  },
  {
    id: "leg-3",
