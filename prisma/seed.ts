...
async function seed() {
  ...
  const rgpdSections = [
    {
      order: 1,
      fr: { heading: "1. Responsable du traitement", body: "Le responsable du traitement des données personnelles est Analyticatech, 12 rue de la Paix, 75002 Paris. Contact : contact@analyticatech.fr." },
      en: { heading: "1. Data Controller", body: "The controller of personal data processing is Analyticatech, 12 rue de la Paix, 75002 Paris. Contact: contact@analyticatech.fr." },
    },
    {
      order: 2,
